    ...
    render(){
        return( 
            <div id='custom_drg'>
                ...
                <p>
                电子病历系统是信息技术和网络技术在医学领域应用的必然产物，为医学研究提供广阔的前景。上海联众研发的电子病历系统（EMR）提供医疗机构内部使用，利用电子计算机保存、管理、传输和重现数字化的病人的医疗记录，在此基础上充分考虑患者信息的保密性，提高医疗质量和医治效率等服务功能的计算机信息系统。系统内设五大功能模块，分别为：门诊医生工作站、住院医生工作站、住院护理电子病历系统、移动查房系统、病历质量控制系统和随访及科研系统。
                </p>
