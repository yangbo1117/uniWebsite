...
export default class Page extends React.Component{
    constructor(props) {
        ...
        this.state = {
            tabs:[
                {tabName:"商务合作",path:'/messages/cooperation',compt:Cooperation},
                {tabName:"招贤纳士",path:'/messages/joinus',compt:Joinus},
            ],
        };
    } 
    componentDidMount(){
                    ...
                    <Col xs={{span:22,offset:1}} sm={{span:22,offset:1}} lg={{span:20,offset:2}} xl={{span:18,offset:3}} xxl={{span:16,offset:4}}>
                        ...
                        <div className='total_solution_route'>
                            <Switch>
                                ...
                                <Redirect exact from='/messages' to='/messages/cooperation'></Redirect>
                            </Switch>
                        </div>
                    </Col>
                </Row>
